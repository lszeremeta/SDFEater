...
[SDF](https://pubs.acs.org/doi/abs/10.1021/ci00007a012) parser written in Java running from command-line interface (CLI). Do you love️ Docker? You can use a lightweight SDFEater container! SDFEater not only ~~eats~~ parse your SDF files, but also can add additional data to the output. The choice of output formats is really wide.
